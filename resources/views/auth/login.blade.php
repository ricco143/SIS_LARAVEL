          ...
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-dark text-center p-3 border-radius-lg">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Login your Account</h4>
                </div>
              </div>
              <div class="card-body"> 
                ...
                @csrf
                  <div class="input-group input-group-outline my-3">
                    <label for="Email Address"></label>
                        <input type="email" id="email" name="email" :value="old('email')" required autofocus autocomplete="username" class="form-control" placeholder="Email Address">
                  </div>
                  <div class="input-group input-group-outline mb-3">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{ route('password.request') }}" class="small text-dark text-gradient text-decoration-none">Forgot password?</a>
                    </div>
