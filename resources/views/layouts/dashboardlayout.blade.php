  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand px-4 py-3 m-0" href="{{route ('dashboard')}}">
        ...
        <span class="ms-1 text-sm text-dark">ADMIN SIS</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active bg-gradient-dark text-dark" href="{{route('students.index')}}">
            <i class="material-symbols-rounded opacity-5">school</i>
            <span class="nav-link-text ms-1">Student List</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link active bg-gradient-dark text-dark" href="{{route('subjects.index')}}">
            <i class="material-symbols-rounded opacity-5">book</i>
            <span class="nav-link-text ms-1">Subject List</span>
          </a>
        </li> 
...
<script>
  ...
  <script>
    var win = navigator.platform.indexOf('Win') > -2;
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    navLinks.forEach((link) => {
      ...
      if (link.href === currentUrl) {
        ...
        navLinks.forEach((nav) => nav.classList.remove("active", "bg-gradient-dark", "text-white"));
