  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand px-4 py-3 m-0" href="{{route ('dashboard')}}">
        ...
        <span class="ms-1 text-sm text-dark">STUDENT SIS</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active bg-gradient-dark text-dark" href="{{route ('student.dashboard')}}">
        ...
        <li class="nav-item">
          <a class="nav-link active bg-gradient-dark text-dark" href="{{route('student.grades')}}">
