                ...
                <div style="height: calc(100vh - 210px); width: 100%; overflow-y: scroll; position:relative">
                    <table class="table table-hover position-relative text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center">{{ $enrollment->subject->code }}</td>
                                <td class="text-center">{{ $enrollment->subject->name }}</td>
                                <td class="text-center">{{ $enrollment->subject->units }}</td>
                                <td class="text-center fw-bold">{{ $enrollment->grade->grade ?? '' }}</td>
                                <td class="text-center {{ optional($enrollment->grade)->status == 'Passed' ? 'text-success' : 'text-danger' }} fw-bold">
